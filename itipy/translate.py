...
from itipy.data.dataset import SOHODataset, HMIContinuumDataset, STEREODataset, KSOFlatDataset, KSOFilmDataset, \
    SWAPDataset, EUIDataset, AIADataset, EUIDataset2
...
class InstrumentToInstrument:
    ...
    def __init__(self, model_name=None, model_path=None, device=None, depth_generator=3, patch_factor=0, n_workers=90):
...
class SolarOrbiterToSDO(InstrumentToInstrument):
    ...
    def __init__(self, model_name='FSI-to-AIA_iter_320k.pt', **kwargs):
        super().__init__(model_name, **kwargs)
        self.norms = [sdo_norms[171], sdo_norms[304]]

    def translate(self, path, basenames=None, **kwargs):
        eui_dataset = EUIDataset2(path, basenames=basenames, **kwargs)
