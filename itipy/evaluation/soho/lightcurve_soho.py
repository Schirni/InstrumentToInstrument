...
# init
base_path = '/gpfs/gpfs0/robert.jarolim/itipy/euv_comparison_v2'
...
translator_stereo = STEREOToSDO(model_path='/gpfs/gpfs0/robert.jarolim/itipy/stereo_to_sdo_v1/generator_AB.pt')
...
print('########## load SOHO ##########')
soho_files = get_intersecting_files("/gpfs/gpfs0/robert.jarolim/data/itipy/soho_iti2021_prep", [171, 195, 284, 304, 'mag', ],
                               ext='.fits')
...
# print('########## load STEREO ##########')
# stereo_files = get_intersecting_files("/gpfs/gpfs0/robert.jarolim/data/itipy/stereo_iti2021_prep",
...
# print('########## load SDO ##########')
# sdo_files = get_intersecting_files("/gpfs/gpfs0/robert.jarolim/data/itipy/sdo", ['171', '193', '211', '304', '6173'], ext='.fits')
