...
from itipy.data.editor import LambdaEditor
...
if __name__ == '__main__':
    base_path = '/gpfs/gpfs0/robert.jarolim/itipy/soho_sdo_euv_v1'
    ...
    soho_path = "/gpfs/gpfs0/robert.jarolim/data/itipy/soho_iti2021_prep"
