...
# init
base_path = '/gpfs/gpfs0/robert.jarolim/itipy/euv_comparison_v1'
os.makedirs(base_path, exist_ok=True)

translator_soho = SOHOToSDO(model_path='/gpfs/gpfs0/robert.jarolim/itipy/soho_sdo_v4/generator_AB.pt')

# translate
basenames_soho = [[os.path.basename(f) for f in glob.glob('/gpfs/gpfs0/robert.jarolim/data/itipy/soho_iti2021_prep/%s/*.fits' % wl)] for
...
basenames_sdo = [[os.path.basename(f) for f in glob.glob('/gpfs/gpfs0/robert.jarolim/data/itipy/sdo_comparison/%s/*.fits' % wl)] for wl in
...
soho_files = [['/gpfs/gpfs0/robert.jarolim/data/itipy/soho_iti2021_prep/%s/%s' % (dir, basename) for basename in basenames_soho]
...
sdo_files = [['/gpfs/gpfs0/robert.jarolim/data/itipy/sdo_comparison/%s/%s' % (dir, basename) for basename in basenames_sdo]
...
plt.savefig('/gpfs/gpfs0/robert.jarolim/itipy/euv_comparison_v1/comparison.jpg')
plt.close()
