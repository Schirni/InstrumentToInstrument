...
from itipy.data.dataset import get_intersecting_files, SDODataset, StorageDataset
...
# init
base_path = "/gpfs/gpfs0/robert.jarolim/itipy/sdo_euv_to_mag_v1"
base_path_abs = "/gpfs/gpfs0/robert.jarolim/itipy/sdo_euv_to_abs_mag_v1"
...
sdo_path = "/gpfs/gpfs0/robert.jarolim/data/itipy/sdo"
...
img_iti_path = os.path.join(prediction_path, 'itipy')
