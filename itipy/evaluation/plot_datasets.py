...
from itipy.data.dataset import HMIContinuumDataset, HinodeDataset, SDODataset, SOHODataset, STEREODataset, KSODataset, \
    KSOFlatDataset, KSOFilmDataset
from itipy.data.editor import RandomPatchEditor

base_path = '/gss/r.jarolim/itipy/datasets'
