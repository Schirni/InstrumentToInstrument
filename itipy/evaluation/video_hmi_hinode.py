...
from itipy.data.align import alignMaps
...
base_path = '/gss/r.jarolim/itipy/hmi_hinode_v12'
...
# imsave(evaluation_path + '/itipy.jpg', iti_sub_map.data, check_contrast=False)
