...
from itipy.data.editor import stereo_norms, sdo_norms
...
# translate
stereo_files = get_intersecting_files('/gpfs/gpfs0/robert.jarolim/data/itipy/stereo_iti2021_prep', ['171', '195', '284', '304', ],
