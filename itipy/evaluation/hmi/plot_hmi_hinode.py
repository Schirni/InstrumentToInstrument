...
base_path = '/gpfs/gpfs0/robert.jarolim/itipy/hmi_hinode_v4'
evaluation_path = os.path.join(base_path, 'plot')
os.makedirs(evaluation_path, exist_ok=True)

hmi_file = '/gpfs/gpfs0/robert.jarolim/data/itipy/hmi_hinode_comparison/2013-11-18T17:46:20.fits'
hinode_file = '/gpfs/gpfs0/robert.jarolim/data/itipy/hinode_iti2022_prep/FG20131118_174620.2.fits'
...
plt.imsave(os.path.join(evaluation_path, 'itipy.jpg'), iti_map.data, origin='lower', cmap='gray')
