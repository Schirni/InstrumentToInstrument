...
hinode_paths = np.array(['/gpfs/gpfs0/robert.jarolim/data/itipy/hinode_iti2022_prep/FG20141219_223311.7.fits'])
hmi_paths = np.array(['/gpfs/gpfs0/robert.jarolim/data/itipy/hmi_hinode_comparison/2014-12-19T22:33:11.fits'])
...
for i, (hmi_map, hinode_map, hinode_path) in tqdm(enumerate(zip(hmi_maps, hinode_maps, hinode_paths)),
    ...
    plt.imsave(p % (os.path.basename(hinode_path), 'itipy'), iti_data, cmap='gray', vmin=0, vmax=1)
