...
# Functions
base_path = '/gpfs/gpfs0/robert.jarolim/itipy/hmi_hinode_baseline'
os.makedirs(base_path, exist_ok=True)

data_path = '/gpfs/gpfs0/robert.jarolim/data/itipy/hmi_hinode_baseline'

df = pd.read_csv('/gpfs/gpfs0/robert.jarolim/data/itipy/hinode_file_list.csv', index_col=False, parse_dates=['date'])
