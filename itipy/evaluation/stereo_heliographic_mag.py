...
from itipy.data.editor import AIAPrepEditor, sdo_norms
...
base = '/gpfs/gpfs0/robert.jarolim/data/itipy/stereo_heliographic_prep'
base_path = "/gpfs/gpfs0/robert.jarolim/itipy/stereo_to_sdo_mag_v1"#"/gss/r.jarolim/itipy/stereo_v7"
