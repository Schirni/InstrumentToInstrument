...
from itipy.data.editor import RandomPatchEditor, SliceEditor, sdo_norms, BrightestPixelPatchEditor
...
from itipy.data.dataset import SDODataset, STEREODataset
from itipy.train.model import DiscriminatorMode
from itipy.trainer import Trainer

import numpy as np

base_path = "/gpfs/gpfs0/robert.jarolim/itipy/stereo_to_sdo_v1"
evaluation_path = os.path.join(base_path, 'evaluation')
os.makedirs(evaluation_path, exist_ok=True)
sdo_valid = SDODataset("/gpfs/gpfs0/robert.jarolim/data/itipy/sdo", resolution=4096, months=[11, 12])
...
stereo_ds = STEREODataset("/gpfs/gpfs0/robert.jarolim/data/itipy/stereo_iti2021_prep", months=[11, 12])
img = stereo_ds[10][0]
