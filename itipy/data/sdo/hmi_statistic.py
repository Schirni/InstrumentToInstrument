...
from itipy.data.dataset import HMIContinuumDataset
from itipy.data.editor import sdo_norms
from itipy.data.loader import HMIContinuumLoader

files = glob.glob('/gpfs/gpfs0/robert.jarolim/data/itipy/hmi_continuum/*.fits')
shuffle(files)
