...
from itipy.data.editor import stereo_norms

plot_path = '/gpfs/gpfs0/robert.jarolim/data/itipy/stereo_imgs'
data_path = '/gpfs/gpfs0/robert.jarolim/data/itipy/stereo_iti2021_prep/304'
...
for bn in to_remove:
    for wl in wls:
        f = os.path.join('/gpfs/gpfs0/robert.jarolim/data/itipy/stereo_iti2021_prep/%s/%s' % (wl, bn))
        if os.path.exists(f):
            print(f)
            os.remove(f)
