...
from itipy.data.editor import soho_norms

plot_path = '/gpfs/gpfs0/robert.jarolim/data/itipy/soho_imgs'
data_path = '/gpfs/gpfs0/robert.jarolim/data/itipy/soho_iti2021_prep/304'
...
shutil.make_archive('/gpfs/gpfs0/robert.jarolim/data/itipy/soho_imgs', 'zip', '/gpfs/gpfs0/robert.jarolim/data/itipy/soho_imgs')
...
for bn in to_remove:
    for wl in wls:
        f = os.path.join('/gpfs/gpfs0/robert.jarolim/data/itipy/soho_iti2021_prep/%s/%s' % (wl, bn))
        if os.path.exists(f):
            print(f)
            os.remove(f)
